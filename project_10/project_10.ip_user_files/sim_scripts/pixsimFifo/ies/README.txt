...
#
# Generated by export_simulation on Sun May 15 16:50:34 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './pixsimFifo.sh' script.

./pixsimFifo.sh -reset_run
...
./pixsimFifo.sh -noclean_files

For more information on the script, please type './pixsimFifo.sh -help'.
