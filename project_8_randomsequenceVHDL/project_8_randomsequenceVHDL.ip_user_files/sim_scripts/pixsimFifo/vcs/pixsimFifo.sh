...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k \
    "$ref_dir/../../../../project_8_randomsequenceVHDL.gen/sources_1/ip/pixsimFifo/sim/pixsimFifo.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.pixsimFifo xil_defaultlib.glbl -o pixsimFifo_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./pixsimFifo_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key pixsimFifo_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc pixsimFifo_simv.daidir)
