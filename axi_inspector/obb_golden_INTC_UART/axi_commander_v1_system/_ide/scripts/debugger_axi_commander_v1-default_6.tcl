...
# Path of this script: C:\Users\ilpes\Desktop\Antenne_e_clocks\obb_golden_INTC_UART\axi_commander_v1_system\_ide\scripts\debugger_axi_commander_v1-default_6.tcl
# 
# 
# Usage with xsct:
# To debug using xsct, launch xsct and run below command
# source C:\Users\ilpes\Desktop\Antenne_e_clocks\obb_golden_INTC_UART\axi_commander_v1_system\_ide\scripts\debugger_axi_commander_v1-default_6.tcl
# 
...
after 3000
targets -set -nocase -filter {name =~ "*microblaze*#0" && bscan=="USER2" }
dow C:/Users/ilpes/Desktop/Antenne_e_clocks/obb_golden_INTC_UART/axi_commander_v1/Release/axi_commander_v1.elf
targets -set -nocase -filter {name =~ "*microblaze*#0" && bscan=="USER2" }
con
