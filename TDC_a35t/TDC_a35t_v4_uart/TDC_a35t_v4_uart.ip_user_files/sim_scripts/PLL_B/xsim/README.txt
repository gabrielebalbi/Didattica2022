...
#
# Generated by export_simulation on Thu Feb 12 23:30:15 +0100 2026
#
################################################################################
...
'-reset_run' switch to the './PLL_B.sh' script.
...
./PLL_B.sh -noclean_files

For more information on the script, please type './PLL_B.sh -help'.
