...
proc create_root_design { parentCell } {
  ...
  set sram_addr [ create_bd_port -dir O -from 18 -to 0 sram_addr ]
  set sram_cen [ create_bd_port -dir O -from 0 -to 0 sram_cen ]
  set sram_dq_i [ create_bd_port -dir I -from 7 -to 0 sram_dq_i ]
  set sram_dq_o [ create_bd_port -dir O -from 7 -to 0 sram_dq_o ]
  set sram_dq_t [ create_bd_port -dir O -from 7 -to 0 sram_dq_t ]
  set sram_oen [ create_bd_port -dir O -from 0 -to 0 sram_oen ]
  set sram_wen [ create_bd_port -dir O sram_wen ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_MEM2_TYPE {1} \
   CONFIG.C_MEM3_TYPE {1} \
  ...
  set_property -dict [ list \
   CONFIG.C_PROCESSOR_CLK_FREQ_MHZ {12} \
   CONFIG.C_S_AXI_ACLK_FREQ_MHZ {12} \
 ] $axi_intc_0
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M03_AXI [get_bd_intf_pins clk_wiz_0/s_axi_lite] [get_bd_intf_pins microblaze_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net microblaze_0_debug [get_bd_intf_pins mdm_1/MBDEBUG_0] [get_bd_intf_pins microblaze_0/DEBUG]
  connect_bd_intf_net -intf_net microblaze_0_dlmb_1 [get_bd_intf_pins microblaze_0/DLMB] [get_bd_intf_pins microblaze_0_local_memory/DLMB]
  connect_bd_intf_net -intf_net microblaze_0_ilmb_1 [get_bd_intf_pins microblaze_0/ILMB] [get_bd_intf_pins microblaze_0_local_memory/ILMB]

  # Create port connections
  connect_bd_net -net axi_emc_0_mem_a [get_bd_pins axi_emc_0/mem_a] [get_bd_pins xlslice_2/Din]
  connect_bd_net -net axi_emc_0_mem_cen [get_bd_ports sram_cen] [get_bd_pins axi_emc_0/mem_cen]
  connect_bd_net -net axi_emc_0_mem_dq_o [get_bd_ports sram_dq_o] [get_bd_pins axi_emc_0/mem_dq_o]
  connect_bd_net -net axi_emc_0_mem_dq_t [get_bd_ports sram_dq_t] [get_bd_pins axi_emc_0/mem_dq_t]
  connect_bd_net -net axi_emc_0_mem_oen [get_bd_ports sram_oen] [get_bd_pins axi_emc_0/mem_oen]
  connect_bd_net -net axi_emc_0_mem_wen [get_bd_ports sram_wen] [get_bd_pins axi_emc_0/mem_wen]
  ...
  connect_bd_net -net mem_dq_i_0_1 [get_bd_ports sram_dq_i] [get_bd_pins axi_emc_0/mem_dq_i]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_emc_0/rdclk] [get_bd_pins axi_emc_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins clk_wiz_0/psclk] [get_bd_pins clk_wiz_0/s_axi_aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
  connect_bd_net -net microblaze_0_Clk_2 [get_bd_ports clk_out1_0] [get_bd_pins clk_wiz_0/clk_out1]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins axi_emc_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins clk_wiz_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]
  ...
  connect_bd_net -net xlslice_2_Dout [get_bd_ports sram_addr] [get_bd_pins xlslice_2/Dout]
