...
## Pmod Header JA
#set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS33} [get_ports {signal_out[0]}]
#set_property -dict {PACKAGE_PIN G19 IOSTANDARD LVCMOS33} [get_ports {signal_out[1]}]
#set_property -dict {PACKAGE_PIN N18 IOSTANDARD LVCMOS33} [get_ports {signal_out[2]}]
#set_property -dict {PACKAGE_PIN L18 IOSTANDARD LVCMOS33} [get_ports {signal_out[3]}]
#set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33} [get_ports {signal_out[4]}]
#set_property -dict {PACKAGE_PIN H19 IOSTANDARD LVCMOS33} [get_ports {signal_out[5]}]
#set_property -dict {PACKAGE_PIN J19 IOSTANDARD LVCMOS33} [get_ports {signal_out[6]}]
#set_property -dict {PACKAGE_PIN K18 IOSTANDARD LVCMOS33} [get_ports {signal_out[7]}]
...
create_clock -period 10.000 -name oclk_pin1 -waveform {0.000 5.000} -add [get_ports  clk_out1_0 ]

#set_property -dict {PACKAGE_PIN C15 IOSTANDARD LVCMOS33} [get_ports {clk_out2_0}]
create_clock -period 10.000 -name oclk_pin2 -waveform {0.000 5.000} -add [get_ports  clk_out2_0 ]
...
set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33 } [get_ports { sram_dq_io[0]   }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=sram-dq[0]
set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { sram_dq_io[1]   }]; #IO_L22P_T3_A05_D21_14 Sch=sram-dq[1]
set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33 } [get_ports { sram_dq_io[2]   }]; #IO_L22N_T3_A04_D20_14 Sch=sram-dq[2]
set_property -dict { PACKAGE_PIN U15   IOSTANDARD LVCMOS33 } [get_ports { sram_dq_io[3]   }]; #IO_L23P_T3_A03_D19_14 Sch=sram-dq[3]
set_property -dict { PACKAGE_PIN U16   IOSTANDARD LVCMOS33 } [get_ports { sram_dq_io[4]   }]; #IO_L23N_T3_A02_D18_14 Sch=sram-dq[4]
set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { sram_dq_io[5]   }]; #IO_L24P_T3_A01_D17_14 Sch=sram-dq[5]
set_property -dict { PACKAGE_PIN V14   IOSTANDARD LVCMOS33 } [get_ports { sram_dq_io[6]   }]; #IO_L24N_T3_A00_D16_14 Sch=sram-dq[6]
set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { sram_dq_io[7]   }]; #IO_25_14 Sch=sram-dq[7]
