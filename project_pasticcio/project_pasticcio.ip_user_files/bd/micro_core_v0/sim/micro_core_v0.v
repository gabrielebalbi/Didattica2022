...
module m03_couplers_imp_SVD2Q1
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
(* CORE_GENERATION_INFO = "micro_core_v0,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=micro_core_v0,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=26,numReposBlks=19,numNonXlnxBlks=0,numHierBlks=7,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=32,da_board_cnt=15,da_clkrst_cnt=20,da_mb_cnt=10,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "micro_core_v0.hwdef" *) 
module micro_core_v0
  ...
  output [0:0]sram_cen;
  input [7:0]sram_dq_i;
  output [7:0]sram_dq_o;
  output [7:0]sram_dq_t;
  output [0:0]sram_oen;
  output sram_wen;
  ...
  wire [18:0]xlslice_2_Dout;

  assign UART_txd = axi_uartlite_0_UART_TxD;
  assign axi_uartlite_0_UART_RxD = UART_rxd;
  assign clk_out1_0 = microblaze_0_Clk_2;
  assign clk_out2_0 = clk_wiz_0_clk_out2;
  assign led0 = clk_wiz_0_locked;
  assign led1 = clk_wiz_0_psdone;
  assign mem_dq_i_0_1 = sram_dq_i[7:0];
  assign reset_0_1 = reset;
  assign sram_addr[18:0] = xlslice_2_Dout;
  assign sram_cen[0] = axi_emc_0_mem_cen;
  assign sram_dq_o[7:0] = axi_emc_0_mem_dq_o;
  assign sram_dq_t[7:0] = axi_emc_0_mem_dq_t;
  assign sram_oen[0] = axi_emc_0_mem_oen;
  assign sram_wen = axi_emc_0_mem_wen;
  assign sys_clock_1 = sys_clock;
  micro_core_v0_axi_emc_0_0 axi_emc_0
  ...
  micro_core_v0_axi_intc_0_0 axi_intc_0
  ...
  micro_core_v0_axi_smc_0 axi_smc
  ...
  micro_core_v0_clk_wiz_1_1 clk_wiz_1
       (.clk_in1(sys_clock_1),
        .clk_out1(microblaze_0_Clk),
        .locked(clk_wiz_1_locked),
        .reset(reset_0_1));
  micro_core_v0_mdm_1_7 mdm_1
  ...
  (* KEEP_HIERARCHY = "yes" *) 
  micro_core_v0_microblaze_0_6 microblaze_0
  ...
  micro_core_v0_microblaze_0_axi_periph_5 microblaze_0_axi_periph
       (.ACLK(microblaze_0_Clk),
        .ARESETN(rst_clk_wiz_1_100M_peripheral_aresetn),
  ...
  micro_core_v0_rst_clk_wiz_1_100M_3 rst_clk_wiz_1_100M
       (.aux_reset_in(1'b1),
  ...
  micro_core_v0_xlslice_1_0 xlslice_1
       (.Din(axi_gpio_0_gpio_io_o),
        .Dout(xlslice_1_Dout));
  micro_core_v0_xlslice_2_0 xlslice_2
       (.Din(axi_emc_0_mem_a),
        .Dout(xlslice_2_Dout));
endmodule

module micro_core_v0_microblaze_0_axi_periph_5
   (ACLK,
    ARESETN,
    M00_ACLK,
    M00_ARESETN,
  ...
  m03_couplers_imp_SVD2Q1 m03_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
...
module microblaze_0_local_memory_imp_1I4M22N
  ...
  (* KEEP_HIERARCHY = "yes" *) 
  micro_core_v0_dlmb_bram_if_cntlr_8 dlmb_bram_if_cntlr
  ...
  micro_core_v0_dlmb_v10_8 dlmb_v10
       (.LMB_ABus(microblaze_0_dlmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_0_dlmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_0_dlmb_bus_BE),
        ...
        .Sl_UE(microblaze_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_0_dlmb_bus_WAIT));
  micro_core_v0_ilmb_bram_if_cntlr_8 ilmb_bram_if_cntlr
  ...
  micro_core_v0_ilmb_v10_8 ilmb_v10
       (.LMB_ABus(microblaze_0_ilmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_0_ilmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_0_ilmb_bus_BE),
        ...
        .Sl_UE(microblaze_0_ilmb_bus_UE),
        .Sl_Wait(microblaze_0_ilmb_bus_WAIT));
  micro_core_v0_lmb_bram_8 lmb_bram
