...
#
# Generated by export_simulation on Fri May 30 14:33:17 +0200 2025
#
################################################################################
...
'-reset_run' switch to the './micro_core_v0.sh' script.

./micro_core_v0.sh -reset_run
...
./micro_core_v0.sh -noclean_files

For more information on the script, please type './micro_core_v0.sh -help'.
