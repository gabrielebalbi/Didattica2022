...
void Init_IO(void)
{
	...
	XGpio_SetDataDirection(&Gpio, 2, 0xf);  // Pushbuttons
	usleep(100);
...
int Init_Interrupt(void)
{
    ...
    stat = XIntc_Connect(&Intc, XPAR_AXI_INTC_0_LED_BUT_GPIO_IP2INTC_IRPT_INTR, (XInterruptHandler)InterruptHandler, (void*) 0);
	usleep(100);
