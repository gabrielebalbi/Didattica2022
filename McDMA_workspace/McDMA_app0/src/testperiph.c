...
int main () 
{
...

   {
      ...
      print("\r\n Running AxiDMASelfTestExample() for axi_dma_16counters...\r\n");

      status = AxiDMASelfTestExample(XPAR_AXI_DMA_16COUNTERS_DEVICE_ID);
...

   {
      ...
      print("\r\n Running IicSelfTestExample() for axi_iic...\r\n");

      status = IicSelfTestExample(XPAR_AXI_IIC_DEVICE_ID);
...
//    }
...

   {
      ...
      print("\r\nRunning GpioOutputExample() for led_but_gpio...\r\n");

      status = GpioOutputExample(XPAR_LED_BUT_GPIO_DEVICE_ID,2);
