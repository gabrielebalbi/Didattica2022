...
#
# Generated by export_simulation on Sun Sep 29 08:17:08 +0200 2024
#
################################################################################
...
'-reset_run' switch to the './gtwizard_0_gtpe2.sh' script.

./gtwizard_0_gtpe2.sh -reset_run
...
./gtwizard_0_gtpe2.sh -noclean_files

For more information on the script, please type './gtwizard_0_gtpe2.sh -help'.
