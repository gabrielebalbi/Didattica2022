...
HD_PWD='C:/Users/ilpes/Desktop/GTPE2/gtwizard_0_gtpe2_ex.runs/ila_DRP_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_DRP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_DRP.tcl
